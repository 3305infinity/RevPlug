...
**Generated At:** 2026-09-03 03:55:00 UTC
**Canonical Benchmark Scale:** 50 cases | Seed 42 | Version `2.0-canonical`
...
In this benchmark of **50 cases** (Seed 42):
...
- **22 AI Proposals Rejected by Deterministic Policy Shield**
- **9 AI Fallbacks Triggered**
- **0 Safety Policy Violations**

RevPlug achieved a **+41.4% Net Recovery Lift** over safe fixed-retry baselines, recovering **₹18,800.00** with **ZERO safety policy violations**.

---

## 2. Benchmark Financial & AI Decision Proof

| Metric | Baseline A (Naive Retry) | Baseline B (Safe Fixed Retry) | RevPlug Bounded AI Agent | Net Uplift |
| :--- | :--- | :--- | :--- | :--- |
...
| **AI Proposals Rejected by Policy** | 0 | 0 | **22** | **100% Policy Shield Protection** |
...
The canonical JSON artifact is at `revenue_recovery/evaluation_report.json`.
