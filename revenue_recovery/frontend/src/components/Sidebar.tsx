...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/customer-view/rec_536f2d77cb8f", label: "Customer Payment Portal", icon: "M3 10h18M7 15h1m4 0h1m-7 4h12a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/recovery/rec_item_demo_hinglish/voice-call", label: "Hinglish Voice PTP Lab", icon: "M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" },
